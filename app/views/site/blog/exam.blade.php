...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="../feiji/css/base.css" />
		<link rel="stylesheet" type="text/css" href="../feiji/css/hotel.css" />
		<meta charset="UTF-8" />
	</head>
	<body>
		<div class="box" id="box">
			...
			<!-- 正文开始  -->
			<div class="content">
				<p style="margin-left:30px;"><span style="font-size:30px;color:#0099ff;">{{ $posts[1]->title }}</span><strong style="color:#333333;">酒店</strong></p>
				<div class="hotel_1">
