		...
		<div class="box" id="box">
			...
			<div class="content">
				<div class="content_title">
					<div class="content_upload_pic"></div>
				</div>
				<div class="content_show_pic">
					<div class="pic_left"><img src="images/left.png" width=45 height=90 /></div>
					<div class="pic_center">
						<table cellspacing=0 cellpadding=0 class="user_all_img" style="width:1100px;">
							<tr>
								<td class="imgs_td"><img src="images/user1.png" width=200 height=200 /></td>
								<td class="imgs_td"><img src="images/user1.png" width=200 height=200 /></td>
								<td class="imgs_td"><img src="images/user1.png" width=200 height=200 /></td>
								<td class="imgs_td"><img src="images/user1.png" width=200 height=200 /></td>
								<td class="imgs_td"><img src="images/user1.png" width=200 height=200 /></td>
					...
					<div class="pic_right"><img src="images/right.png" width=45 height=90 /></div>
				</div>
